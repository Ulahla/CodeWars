...
// Note: This one really opened my eyes how regex can be used - a thing I never have to do at work.
...
//    public static String SongDecoder (String song) {
//      // trying it stepwise
//      //String a =  song.replaceAll("WUBWUB", " ")
...
//
//      // combining the steps
//      return song.replaceAll("WUBWUB", " ").replaceAll("WUB", " ").replaceAll("  ", " ").trim();
//    }
//  }
